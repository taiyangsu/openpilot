...
class NoEntryAlert(Alert):
  def __init__(self, alert_text_2: str, alert_text_1: str = "系统不可用", visual_alert: car.CarControl.HUDControl.VisualAlert=VisualAlert.none):
    super().__init__(alert_text_1, alert_text_2, AlertStatus.normal, AlertSize.mid, Priority.LOW, visual_alert, AudibleAlert.refuse, 3.)


class SoftDisableAlert(Alert):
  def __init__(self, alert_text_2: str):
    super().__init__("请立即接管控制", alert_text_2, AlertStatus.userPrompt, AlertSize.full, Priority.MID, VisualAlert.steerRequired, AudibleAlert.warningSoft, 2.)
...
class UserSoftDisableAlert(SoftDisableAlert):
  def __init__(self, alert_text_2: str):
    ...
    self.alert_text_1 = "系统即将解除"


class ImmediateDisableAlert(Alert):
  def __init__(self, alert_text_2: str):
    super().__init__("立即接管控制", alert_text_2, AlertStatus.critical, AlertSize.full, Priority.HIGHEST, VisualAlert.steerRequired, AudibleAlert.warningImmediate, 4.)
...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "请随时准备接管", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
def startup_master_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  ...
  return StartupAlert("警告：此分支未经测试", "请谨慎使用", alert_status=AlertStatus.userPrompt)

def below_engage_speed_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  return NoEntryAlert(f"请将车速提高至 {get_display_speed(CP.minEnableSpeed, metric)} 以上再启用")
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.longitudinalManeuver: {
    ...
    ET.PERMANENT: NormalPermanentAlert("纵向控制模式", "请确保前方道路畅通"),
  },
  ...
  EventName.startupNoControl: {
    ET.PERMANENT: StartupAlert("仪表盘摄像头模式"),
    ET.NO_ENTRY: NoEntryAlert("仪表盘摄像头模式"),
  },

  EventName.startupNoCar: {
    ET.PERMANENT: StartupAlert("不支持的车型-仪表盘摄像头模式"),
  },

  EventName.startupNoSecOcKey: {
    ET.PERMANENT: NormalPermanentAlert("仪表盘摄像头模式", "安全密钥不可用", priority=Priority.HIGH),
  },

  EventName.dashcamMode: {
    ET.PERMANENT: NormalPermanentAlert("仪表盘摄像头模式", priority=Priority.LOWEST),
  },
  ...
  EventName.carUnrecognized: {
    ET.PERMANENT: NormalPermanentAlert("仪表盘摄像头模式", "车未识别", priority=Priority.LOWEST),
  },
  ...
  EventName.aeb: {
    ...
    ET.NO_ENTRY: NoEntryAlert("自动紧急制动：碰撞风险"),
  },
  ...
  EventName.stockAeb: {
    ET.PERMANENT: Alert(
      ...
      AlertStatus.critical, AlertSize.full,
      Priority.HIGHEST, VisualAlert.fcw, AudibleAlert.none, 2.),
    ET.NO_ENTRY: NoEntryAlert("车辆 AEB：碰撞风险"),
  },
  ...
  EventName.locationdTemporaryError: {
    ET.NO_ENTRY: NoEntryAlert("定位系统临时错误"),
    ET.SOFT_DISABLE: soft_disable_alert("定位系统临时错误"),
  },

  EventName.locationdPermanentError: {
    ET.NO_ENTRY: NoEntryAlert("定位系统永久错误"),
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("定位系统永久错误"),
    ET.PERMANENT: NormalPermanentAlert("定位系统永久错误"),
  },
  ...
  EventName.paramsdTemporaryError: {
    ET.NO_ENTRY: NoEntryAlert("参数系统临时错误"),
    ET.SOFT_DISABLE: soft_disable_alert("参数系统临时错误"),
  },

  EventName.paramsdPermanentError: {
    ET.NO_ENTRY: NoEntryAlert("参数系统永久错误"),
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("参数系统永久错误"),
    ET.PERMANENT: NormalPermanentAlert("参数系统永久错误"),
  },
  ...
  EventName.buttonCancel: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage),
    ET.NO_ENTRY: NoEntryAlert("已按下取消按钮"),
  },
  ...
  EventName.resumeBlocked: {
    ET.NO_ENTRY: NoEntryAlert("请按 SET 键启用"),
  },
  ...
  EventName.steerTimeLimit: {
    ET.SOFT_DISABLE: soft_disable_alert("车辆转向时间超限"),
    ET.NO_ENTRY: NoEntryAlert("车辆转向时间超限"),
  },
  ...
  EventName.wrongGear: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage),
    ET.NO_ENTRY: NoEntryAlert("请切换至 D 档"),
  },
  ...
  EventName.calibrationIncomplete: {
    ...
    ET.NO_ENTRY: NoEntryAlert("正在校准中"),
  },
  ...
  EventName.espDisabled: {
    ET.SOFT_DISABLE: soft_disable_alert("电子稳定系统已禁用"),
    ET.NO_ENTRY: NoEntryAlert("电子稳定系统已禁用"),
  },
  ...
  EventName.accFaulted: {
    ...
    ET.PERMANENT: NormalPermanentAlert("巡航系统故障：请重启车辆后再启用"),
  ...
  EventName.steerUnavailable: {
    ...
    ET.PERMANENT: NormalPermanentAlert("LKAS 故障：请重启车辆后再启用"),
  ...
  EventName.cruiseDisabled: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("巡航系统已关闭"),
  },
  ...
  EventName.speedTooHigh: {
    ...
    ET.NO_ENTRY: NoEntryAlert("请降低车速以启用"),
  },

  EventName.vehicleSensorsInvalid: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("车辆传感器无效"),
    ET.PERMANENT: NormalPermanentAlert("车辆传感器校准中", "请继续驾驶以校准"),
